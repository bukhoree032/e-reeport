...
<div class="card-toolbar">
  <form action="{{ route('admin.index.now_search') }}" method="POST" enctype="multipart/form-data">  
    @csrf
    <div class="row">
        <div class="col-md-2">
          <label>เดือน</label>
...
<div class="row">
  <div class="col-lg-6">
    <div class="card">
      <h5 class="card-header">รายงานการประชุม  ({{count($result)}} ตำบล)</h5>
                  ...
                  <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a target="_blank" class="dropdown-item" href="{{ route('admin.index.reportuser',$value->id) }}"><i class="bx bx-eye me-2"></i> ดูรายงานการประชุม</a>
                        </div>
                      </div>
                  </td>
              </tr>    
  ...
  <div class="col-lg-6">
    <div class="card">
      <h5 class="card-header">ยังไม่รายงานการประชุม  ({{count($result_no)}} ตำบล)</h5>
      <div class="table-responsive text-nowrap">
        <table class="table">
          <thead>
            <tr>
