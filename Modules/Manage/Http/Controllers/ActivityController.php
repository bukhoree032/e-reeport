...
class ActivityController extends UploadeFileController
{
    ...
    public function create()
    {
        ...
        return view('manage::activity.form_activity', compact('page_title', 'page_description'),$data);
    }
    ...
    {
        $data['resulta'] = $this->Repository->insert($request->all(),'classModelActivity');
        ...
        return redirect()->route('index.activity',$data['resulta']['id']);
    } 
    
    public function PageEditactivity($id)
    {
        $page_title = 'แก้ไขข้อมูลบันทึกการประชุม';
        $page_description = '';

        $data['resultID'] = $this->Repository->ShowId($id,'activity');
        ...
        return view('manage::activity.edit_activity', compact('page_title', 'page_description'),$data);
    }
    ...
    public function Updateactivity(Request $request,$id)
    {
        ...
        $data['result'] = $this->Repository->update($request->all(),$id,'classModelActivity');
    ...
    public function Detail_activity($id)
    {
        ...
        return view('manage::activity.detail_activity', compact('page_title', 'page_description'),$data);
    }
