                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="district1" value="{{auth::user()->districts}}" readonly  placeholder="รายงานผลการดำเนินงานสภาสันติสุขตำบล" />
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 margin_top">
                                ...
                                <input type="number" class="form-control" name="activity[{{$key}}][approve]" placeholder="การเบิกจ่ายงบประมาณ (ได้รับอนุมัติ)" value="{{$value->budget}}"/>
                            </div>
                            <div class="col-lg-3 margin_top">
                                <label>การเบิกจ่ายงบประมาณ (เบิก-จ่าย):</label>
                                <input type="number" class="form-control" name="activity[{{$key}}][withdraw]" placeholder="การเบิกจ่ายงบประมาณ (เบิก-จ่าย)" />
                            </div>
                            <div class="col-lg-3 margin_top">
                            ...
                            <div class="col-lg-3 margin_top">
                                ...
                                <input type="number" class="form-control" name="activity[{{$key}}][income]" placeholder="ผลการดำเนินงาน (รายได้ที่ได้รับจากกิจกรรม (บาท))" />
                            </div>
                            <div class="col-lg-3 margin_top">
